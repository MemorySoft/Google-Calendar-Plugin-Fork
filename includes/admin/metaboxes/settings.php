...
class Settings implements Meta_Box {
	...
	private static function settings_handle( $post ) {
		...
		if ( $feed_options ) {
			...
			?>
			<label for="_feed_type"><span><?php _e( 'Eventos desde', 'google-calendar-events' ); ?></span>
				<select name="_feed_type" id="_feed_type">
					<optgroup label="<?php _ex( 'Fuente:', 'From which calendar source to load events from', 'google-calendar-events' ) ?>">
		...
		if ( $calendar_options ) {
			...
			?>
			<label for="_calendar_type"><span><?php _e( 'Calendario', 'google-calendar-events' ); ?></span>
				<select name="_calendar_type" id="_calendar_type">
					<optgroup label="<?php _e( 'Escoge uno:', 'google-calendar-events' ); ?>">
			...
			if ( $calendar_views ) {
				...
				foreach ( $calendar_views as $calendar => $views ) {
					...
					?>
					<label for="_calendar_view_<?php echo $calendar; ?>"><span><?php _e( 'Vista', 'google-calendar-events' ); ?></span>
						<select name="_calendar_view[<?php echo $calendar; ?>]" id="_calendar_view_<?php echo $calendar; ?>">
							<optgroup label="<?php _e( 'Mostrar como', 'google-calendar-events' ); ?>">
	...
	private static function events_settings_panel( $post ) {
		...
		<table>
			<thead>
			<tr><th colspan="2"><?php _e( 'Ajustes de eventos', 'google-calendar-events' ); ?></th></tr>
			</thead>
			<tbody class="simcal-panel-section simcal-panel-section-events-range">
			<tr class="simcal-panel-field">
				<th><label for="_calendar_begins"><?php _e( 'Evento inicial', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					<select name="_calendar_begins"
						...
						<optgroup label="<?php _e( 'Días', 'google-calendar-events' ); ?>">
							<option value="today"
									data-hide-fields="_calendar_begins_custom_date,_calendar_begins_nth"
								<?php selected( 'today', $calendar_begins, true ); ?>><?php _e( 'Hoy', 'google-calendar-events' ); ?></option>
							<option value="now"
									data-hide-fields="_calendar_begins_custom_date,_calendar_begins_nth"
								<?php selected( 'now', $calendar_begins, true ); ?>><?php _e( 'Ahora', 'google-calendar-events' ); ?></option>
							<option value="days_before"
									data-hide-field="_calendar_begins_custom_date"
									data-show-field="_calendar_begins_nth" <?php selected( 'days_before', $calendar_begins, true ); ?>><?php _e( 'Día(s) antes de hoy', 'google-calendar-events' ); ?></option>
							<option value="days_after"
									data-hide-field="_calendar_begins_custom_date"
									data-show-field="_calendar_begins_nth" <?php selected( 'days_after', $calendar_begins, true ); ?>><?php _e( 'Día(s) después de hoy', 'google-calendar-events' ); ?></option>
						</optgroup>
						<optgroup label="<?php _e( 'Weeks', 'google-calendar-events' ); ?>">
							<option value="this_week"
									data-hide-fields="_calendar_begins_custom_date,_calendar_begins_nth"
								<?php selected( 'this_week', $calendar_begins, true ); ?>><?php _e( 'Esta semana', 'google-calendar-events' ); ?></option>
							<option value="weeks_before"
									data-hide-field="_calendar_begins_custom_date"
									data-show-field="_calendar_begins_nth" <?php selected( 'weeks_before', $calendar_begins, true ); ?>><?php _e( 'Semana(s) antes de la actual', 'google-calendar-events' ); ?></option>
							<option value="weeks_after"
									data-hide-field="_calendar_begins_custom_date"
									data-show-field="_calendar_begins_nth" <?php selected( 'weeks_after', $calendar_begins, true ); ?>><?php _e( 'Semana(s) después de la actual', 'google-calendar-events' ); ?></option>
						</optgroup>
						<optgroup label="<?php _e( 'Months', 'google-calendar-events' ); ?>">
							<option value="this_month"
									data-hide-fields="_calendar_begins_custom_date,_calendar_begins_nth"
								<?php selected( 'this_month', $calendar_begins, true ); ?>><?php _e( 'Este mes', 'google-calendar-events' ); ?></option>
							<option value="months_before"
									data-hide-field="_calendar_begins_custom_date"
									data-show-field="_calendar_begins_nth" <?php selected( 'months_before', $calendar_begins, true ); ?>><?php _e( 'Mes(es) antes del actual', 'google-calendar-events' ); ?></option>
							<option value="months_after"
									data-hide-field="_calendar_begins_custom_date"
									data-show-field="_calendar_begins_nth" <?php selected( 'months_after', $calendar_begins, true ); ?>><?php _e( 'Mes(es) después del actual', 'google-calendar-events' ); ?></option>
						</optgroup>
						<optgroup label="<?php _e( 'Years', 'google-calendar-events' ); ?>">
							<option value="this_year"
									data-hide-fields="_calendar_begins_custom_date,_calendar_begins_nth"
								<?php selected( 'this_year', $calendar_begins, true ); ?>><?php _e( 'Este año', 'google-calendar-events' ); ?></option>
							<option value="years_before"
									data-show-field="_calendar_begins_nth" <?php selected( 'years_before', $calendar_begins, true ); ?>><?php _e( 'Año(s) antes del actual', 'google-calendar-events' ); ?></option>
							<option value="years_after"
									data-hide-field="_calendar_begins_custom_date"
									data-show-field="_calendar_begins_nth" <?php selected( 'years_after', $calendar_begins, true ); ?>><?php _e( 'Año(s) después del actual', 'google-calendar-events' ); ?></option>
						</optgroup>
						<optgroup label="<?php _e( 'Other', 'google-calendar-events' ); ?>">
							<option value="custom_date"
									data-hide-field="_calendar_begins_nth"
									data-show-field="_calendar_begins_custom_date" <?php selected( 'custom_date', $calendar_begins, true ); ?>><?php _e( 'Fecha personalizada', 'google-calendar-events' ); ?></option>
						</optgroup>
					</select>
					<?php
					...
					<i class="simcal-icon-help simcal-help-tip"
					   data-tip="<?php _e( 'Fecha de inicio del calendario. Se adaptara automáticamente en base al tipo de calendario.', 'google-calendar-events' ); ?>"></i>
				</td>
			</tr>
			<tr class="simcal-panel-field">
				<th><label for="_feed_earliest_event_date"><?php _e( 'Primer evento', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					<select name="_feed_earliest_event_date"
							...
							class="simcal-field simcal-field-select simcal-field-inline simcal-field-switch-other">
						<option value="calendar_start" data-hide-field="_feed_earliest_event_date_range" <?php selected( 'calendar_start', $earliest_event, true ); ?>><?php _e( 'Igual que la fecha de inicio', 'google-calendar-events' ); ?></option>
						<option value="days_before"    data-show-field="_feed_earliest_event_date_range" <?php selected( 'days_before', $earliest_event, true ); ?>><?php _e( 'Día(s) antes de la fecha de inicio', 'google-calendar-events' ); ?></option>
						<option value="weeks_before"   data-show-field="_feed_earliest_event_date_range" <?php selected( 'weeks_before', $earliest_event, true ); ?>><?php _e( 'Semana(s) antes de la fecha de inicio', 'google-calendar-events' ); ?></option>
						<option value="months_before"  data-show-field="_feed_earliest_event_date_range" <?php selected( 'months_before', $earliest_event, true ); ?>><?php _e( 'Mes(es) antes de la fecha de inicio', 'google-calendar-events' ); ?></option>
						<option value="years_before"   data-show-field="_feed_earliest_event_date_range" <?php selected( 'years_before', $earliest_event, true ); ?>><?php _e( 'Año(s) antes de la fecha de inicio', 'google-calendar-events' ); ?></option>
					</select>
					<i class="simcal-icon-help simcal-help-tip"
					   data-tip="<?php _e( 'Ajusta la fecha del evento inicial de este calendario. No se mostrarán eventos antes de esa fecha.', 'google-calendar-events' ); ?>"></i>
				</td>
			</tr>
			<tr class="simcal-panel-field">
				<th><label for="_feed_latest_event_date"><?php _e( 'Evento final', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					<select name="_feed_latest_event_date"
							...
							class="simcal-field simcal-field-select simcal-field-inline simcal-field-switch-other">
						<option value="calendar_start" data-hide-field="_feed_latest_event_date_range" <?php selected( 'calendar_start', $earliest_event, true ); ?>><?php _e( 'Último día de la fecha de inicio', 'google-calendar-events' ); ?></option>
						<option value="days_after"     data-show-field="_feed_latest_event_date_range" <?php selected( 'days_after', $latest_event, true ); ?>><?php _e( 'Día(s) después de la fecha de inicio', 'google-calendar-events' ); ?></option>
						<option value="weeks_after"    data-show-field="_feed_latest_event_date_range" <?php selected( 'weeks_after', $latest_event, true ); ?>><?php _e( 'Semana(s) después de la fecha de inicio', 'google-calendar-events' ); ?></option>
						<option value="months_after"   data-show-field="_feed_latest_event_date_range" <?php selected( 'months_after', $latest_event, true ); ?>><?php _e( 'Mes(es) después de la fecha de inicio', 'google-calendar-events' ); ?></option>
						<option value="years_after"    data-show-field="_feed_latest_event_date_range" <?php selected( 'years_after', $latest_event, true ); ?>><?php _e( 'Año(s) después de la fecha de inicio', 'google-calendar-events' ); ?></option>
					</select>
					<i class="simcal-icon-help simcal-help-tip"
					   data-tip="<?php _e( 'Ajusta la fecha del evento final de este calendario. No se mostrarán eventos antes de esa fecha.', 'google-calendar-events' ); ?>"></i>
				</td>
			</tr>
			</tbody>
		</table>
	...
	private static function calendar_settings_panel( $post ) {
		...
		<table>
			<thead>
			<tr><th colspan="2"><?php _e( 'Miscellanea', 'google-calendar-events' ); ?></th></tr>
			</thead>
			<tbody class="simcal-panel-section">
			<tr class="simcal-panel-field">
				<th><label for="_calendar_is_static"><?php _e( 'Calendario estático', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					simcal_print_field( array(
						...
						'tooltip' => __( 'Esconde la flechas de navegación y ajusta el calendario en su fecha inicial.', 'google-calendar-events' ),
			...
			<tr class="simcal-panel-field">
				<th><label for="_no_events_message"><?php _e( 'Mensaje sin eventos', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					simcal_print_field( array(
						...
						'tooltip' => __( 'Algunos calendarios muestran un mensaje cuando no tienen eventos. Cambia el mensaje por defecto aquí.', 'google-calendar-events' ),
			...
			<tr class="simcal-panel-field">
				<th><label for="_event_formatting"><?php _e( 'Formato', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					simcal_print_field( array(
						...
						'tooltip' => __( 'Para conservar los saltos de linea y los parágrafos en el editor de eventos.', 'google-calendar-events' ),
						'value'   => $event_formatting,
						'default' => 'preserve_linebreaks',
						'options' => array(
							'preserve_linebreaks' => __( 'Conservar los saltos de linea, auto-parágrafos (por defecto)', 'google-calendar-events' ),
							'no_linebreaks'       => __( 'Sin saltos de linea, auto-parágrafos', 'google-calendar-events' ),
							'none'                => __( 'saltos de linea, sin auto-parágrafos', 'google-calendar-events' ),
						),
					) );
	...
	private static function advanced_settings_panel( $post ) {
		...
		<table>
			<thead>
			<tr><th colspan="2"><?php _e( 'Fecha y hora', 'google-calendar-events' ); ?></th></tr>
			</thead>
			<tbody class="simcal-panel-section simcal-panel-datetime-formatting">
			<tr class="simcal-panel-field">
				<th><label for="_calendar_timezone_setting"><?php _e( 'Zona horaria', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					<select name="_feed_timezone_setting"
						...
						<option value="use_site" <?php selected( 'use_site', $timezone_setting, true ); ?>><?php printf( _x( 'Usar ajustes del sitio', 'Use this site default setting', 'google-calendar-events' ) . ' (%s)', $timezone_default ); ?></option>
						<?php if ( $show_use_calendar ) { ?>
							<option id="use_calendar" value="use_calendar" data-show-field="_use_calendar_warning" <?php selected( 'use_calendar', $timezone_setting, true ); ?>><?php _ex( 'Usar ajustes de la fuente de eventos', 'Use the calendar default setting', 'google-calendar-events' ); ?></option>
						<?php } ?>
						<option value="use_custom" data-show-field="_feed_timezone" <?php selected( 'use_custom', $timezone_setting, true ); ?>><?php _ex( 'Personalizado', 'Use a custom setting', 'google-calendar-events' ); ?></option>
					</select>
					...
					<i class="simcal-icon-help simcal-help-tip" data-tip="<?php _e( 'Usar una zona horaria diferente puede alterar la fecha y la hora en la que aparezcan los eventos. Házlo solo si sabes lo que estás haciendo.', 'google-calendar-events' ); ?>"></i>
					<p id="_use_calendar_warning" style="display: none;" class="simcal-field">
						<?php printf( __( '<strong>OJO:</strong> Esta opción puede dar resultados inesperados si has configurado la zona horaria <a href="%s" target="_blank">en el evento</a>.', 'google-calendar-events' ), 'http://docs.simplecalendar.io/timezone-settings/' ); ?>
					</p>
				</td>
			</tr>
			<tr class="simcal-panel-field">
				<th><label for="_calendar_date_format_setting"><?php _e( 'Formato de fecha', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					<select name="_calendar_date_format_setting"
						...
						<option value="use_site" data-show-field="_calendar_date_format_default" <?php selected( 'use_site', $date_format_setting, true ); ?>><?php  _ex( 'Ajustes del sitio', 'Use this site default setting', 'google-calendar-events' ); ?></option>
						<option value="use_custom" data-show-field="_calendar_date_format" <?php selected( 'use_custom', $date_format_setting, true ); ?>><?php _ex( 'Personalizado', 'Use a custom setting', 'google-calendar-events' ); ?></option>
						<option value="use_custom_php" data-show-field="_calendar_date_format_php_field" <?php selected( 'use_custom_php', $date_format_setting, true ); ?>><?php _e( 'Personalizado (PHP)', 'google-calendar-events' ); ?></option>
					</select>
					<i class="simcal-icon-help simcal-help-tip" data-tip="<?php _e( 'Esta opción ajusta el formato de la fecha. Si no sabes lo que haces, no toques nada...', 'google-calendar-events' ); ?>"></i>
					<p id="_calendar_date_format_default" style="<?php echo $date_format_setting != 'use_site' ? 'display: none;' : ''; ?>">
						<em><?php _e( 'Previsualización', 'google-calendar-events' ) ?>:</em>&nbsp;&nbsp;
					...
					<div class="simcal-field-datetime-format-php" id="_calendar_date_format_php_field" style="<?php echo $date_format_setting != 'use_custom_php' ? 'display: none;' : ''; ?>">
						...
						<label for="_calendar_date_format_php">
							...
							<?php printf( __( 'Introduce un formato de fecha usando valores %s.', 'google-calendar-events' ), '<a href="//php.net/manual/en/function.date.php" target="_blank">PHP</a>' ); ?>
						</label>
						<p>
							<em><?php _e( 'Previsualización', 'google-calendar-events' ) ?>:</em>&nbsp;&nbsp;
			...
			<tr class="simcal-panel-field">
				<th><label for="_calendar_datetime_separator"><?php _e( 'Separador', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					simcal_print_field( array(
						...
						'value'   => $separator,
						'tooltip' => __( 'Se usa para separar la fecha de la hora cuando se muestran juntas.', 'google-calendar-events' ),
						'class'   => array(
							'simcal-field-tiny',
						),
					) );
			...
			<tr class="simcal-panel-field">
				<th><label for="_calendar_time_format_setting"><?php _e( 'Formato de la hora', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					<select name="_calendar_time_format_setting"
							...
							class="simcal-field simcal-field-select simcal-field-show-other">
						<option value="use_site" data-show-field="_calendar_time_format_default" <?php selected( 'use_site', $time_format_setting, true ); ?>><?php _ex( 'Ajustes del sitio', 'Use this site default setting', 'google-calendar-events' ); ?></option>
						<option value="use_custom" data-show-field="_calendar_time_format" <?php selected( 'use_custom', $time_format_setting, true ); ?>><?php _ex( 'Personalizado', 'Use a custom setting', 'google-calendar-events' ); ?></option>
						<option value="use_custom_php" data-show-field="_calendar_time_format_php_field" <?php selected( 'use_custom_php', $time_format_setting, true ); ?>><?php _e( 'Personalizado (PHP)', 'google-calendar-events' ); ?></option>
					</select>
					<i class="simcal-icon-help simcal-help-tip" data-tip="<?php _e( 'Esta opción ajusta el formato de la hora. Si no sabes lo que haces...', 'google-calendar-events' ); ?>"></i>
			...
			<tr class="simcal-panel-field">
				<th><label for="_calendar_week_starts_on_setting"><?php _e( 'Inicio de semana el', 'google-calendar-events' ); ?></label></th>
				<td>
					<?php
					...
					<select
						...
						<option value="use_site" <?php selected( 'use_site', $week_starts_setting, true ); ?>><?php printf( _x( 'Ajustes del sitio', 'Use this site default setting', 'google-calendar-events' ) . ' (%s)', date_i18n( 'l', strtotime( "Sunday + $week_starts_default Days" ) ) ); ?></option>
						<option value="use_custom" <?php selected( 'use_custom', $week_starts_setting, true ); ?>><?php _ex( 'Personalizado', 'Use a custom setting', 'google-calendar-events' ); ?></option>
					</select>
					<select
					...
					<i class="simcal-icon-help simcal-help-tip" data-tip="<?php _e( 'Algunos calendarios usan este ajuste para mostrar el inicio de la semana. Se recomienda mantener los ajustes de este sitio.', 'google-calendar-events' ); ?>"></i>
				</td>
			</tr>
			</tbody>
		</table>
		<table>
			<thead>
			<tr><th colspan="2"><?php _e( 'Caché', 'google-calendar-events' ); ?></th></tr>
			</thead>
			...
			?>
			<tr class="simcal-panel-field">
				<th><label for="_feed_cache_user_amount"><?php _ex( 'Intervalo de refresco', 'Cache maximum interval', 'google-calendar-events' ); ?></label></th>
				<td>
					<input type="number"
					...
					<select name="_feed_cache_user_unit"
						...
						<option value="60" <?php selected( '60', $cache_unit, true ); ?>><?php _e( 'Minuto(s)', 'google-calendar-events' ); ?></option>
						<option value="3600" <?php selected( '3600', $cache_unit, true ); ?>><?php _e( 'Hora(s)', 'google-calendar-events' ); ?></option>
						<option value="86400" <?php selected( '86400', $cache_unit, true ); ?>><?php _e( 'Día(s)', 'google-calendar-events' ); ?></option>
						<option value="604800" <?php selected( '604800', $cache_unit, true ); ?>><?php _e( 'Semana(s)', 'google-calendar-events' ); ?></option>
					</select>
					<i class="simcal-icon-help simcal-help-tip" data-tip="<?php _e( 'Si añades, quitas o editas eventos con mucha frecuencia, es recomendable usar un intervalo corto de refresco. Usa una intervalo alto para mejorar el desempeño.', 'google-calendar-events' ); ?>"></i>
				</td>
			</tr>
			</tbody>
		</table>
