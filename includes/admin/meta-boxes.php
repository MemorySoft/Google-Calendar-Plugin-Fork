...
class Meta_Boxes {
	...
	public function add_meta_boxes() {
		...
		add_meta_box(
			...
			__( 'Configuración del calendario', 'google-calendar-events' ),
		...
		add_meta_box(
			...
			__( 'Shortcode para insertar', 'google-calendar-events' ),
		...
		if ( ( true == simcal_get_calendars() ) && ! empty( $this->post_types ) ) {
			foreach ( $this->post_types as $post_type ) {
				add_meta_box(
					...
					__( 'Inserta un calendario', 'google-calendar-events' ),
