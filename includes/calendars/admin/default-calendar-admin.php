...
class Default_Calendar_Admin {
	...
	public function add_settings_meta_calendar_panel( $post_id ) {
		...
		<table id="default-calendar-settings">
			...
			$default_today_color        = '#22bb5b'/*isset( $settings['default-calendar']['today_color'] ) ? $settings['default-calendar']['today_color'] :*/;
			$default_days_events_color  = '#54075b'/*isset( $settings['default-calendar']['days_events_color'] ) ? $settings['default-calendar']['days_events_color'] :*/;
	...
	public function process_meta( $post_id ) {
		...
		// Today color.
		$today_color = isset( $_POST['_default_calendar_style_today'] ) ? sanitize_text_field( $_POST['_default_calendar_style_today'] ) : '#22bb5b';
		update_post_meta( $post_id, '_default_calendar_style_today', $today_color );

		// Days with events color.
		$days_events_color = isset( $_POST['_default_calendar_style_days_events'] ) ? sanitize_text_field( $_POST['_default_calendar_style_days_events'] ) : '#54075b';
		...
		$bubbles = isset( $_POST['_default_calendar_event_bubble_trigger'] ) ? esc_attr( $_POST['_default_calendar_event_bubble_trigger'] ) : 'click';
